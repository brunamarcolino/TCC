            ...
            if (!mensagem.equals("")){    
                ...
                if (token.equals("Erro")){
                    ...
                    String corpo = ("<p style='font-family: Arial, sans-serif'>Olá,"+login+"  </p>" +
                                    ...
                                    "<p style='font-family: Arial, sans-serif'>Você pode redefinir a sua senha <a href=\"https://smartqueue.com.br/RecuperarDadosToken?token="+token+"\">aqui</a>. A sua nova senha deve:</p>" +
