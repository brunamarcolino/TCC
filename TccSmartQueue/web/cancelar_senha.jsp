...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <title>Smartqueue - Cancelar Senha</title>
    ...
    <body>
        ...
        <div class="main">
            <div class="grid-25 mobile-grid-100 section-center">
                <div class="box">
                    <h1>Cancelar Senha</h1>
                </div>
                <form action="CancelarSenhaServlet?id_senha=${param.id_senha}" method="post">
                    <ul>
                        <li> 
                            <h3>Tem certeza que deseja cancelar sua senha?</h3>              
                        </li>
                        <li class="btn-group">
